...
scavetool export  -f 'module(*.LISPRouter.*) AND name(packetDropQueueOverflow:count)' -o results/VC_with_FTP_Only_packetDropQueueOverflow_count.csv -F CSV-S results/VC_with_FTP_Only-*.sca
scavetool export  -f 'module(*.LISPRouter.*) AND name(packetDropQueueOverflow:count)' -o results/VC_with_HTTP_Only_packetDropQueueOverflow_count.csv -F CSV-S results/VC_with_HTTP_Only-*.sca
scavetool export  -f 'module(*.LISPRouter.*) AND name(packetDropQueueOverflow:count)' -o results/VC_with_FTP_and_HTTP_packetDropQueueOverflow_count.csv -F CSV-S results/VC_with_FTP_and_HTTP-*.sca
