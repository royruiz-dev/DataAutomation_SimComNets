...
scavetool export  -f '(module(*.AP.*ueue) AND name(queueLength:max)) OR (module(*Router.*) AND name(queueLength:max))' -o results/HTTP_Clients_4_queueLength_max.csv -F CSV-S results/VC_with_FTP_and_HTTP-*.sca
